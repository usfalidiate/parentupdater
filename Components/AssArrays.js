        ...
        tasks: [
            {
                ...
                taskDescription: 'Students design and conduct their own scientific experiment, analyse and evaluate their data, and report their findings.',
                taskWeighting: '30%',
                successCriteria: ['Specific task criteria will be handed out with the assessment notification closer to the due date.'],
            ...
            },
            {
                ...
                taskWeighting: '30%',
                successCriteria: ["Each individual portfolio task will have specific success criteria that will be outlined in class."],
            ...
            },
            {
                ...
                taskDescription: 'A formal, written exam that will be held during class',
                taskWeighting: '40%',
                successCriteria: ['Specific task criteria will be handed out with the assessment notification closer to the due date.'],
                taskOutcomes: ["SC5-13ES", "SC5-15LW", "SC5-10PW", "SC5-17CW", "SC5-14LW", "SC5-4WS", "SC5-5WS", "SC5-6WS", "SC5-7WS", "SC5-8WS", "SC5-9WS"],
                date: "Early Term 4",
...
export const STEMAssArray = [
    {
        ...
        tasks: [
            ...
            },
            {
                ...
                date: "End of Term 3", 
                successCriteria: [
                    "1. Build a scale-model car park facility, using Matchbox cars as vehicles. ", 
                    "2. Code a software program capable of counting the number of available spaces in the carpark. ",
                    "3. Install digital hardware (Arduino, ultrasonic sensors, and LED displays) that detect and display the number of available spaces in the carpark.  ",
                    "4. Ensure all working spaces are consistently kept clean and safe, with all equipment appropriately used and stored.  ",
                ]
            },
            {
                taskNumber: 4,
       ...
       tasks: [
           {
               ...
               taskDescription: 'Students complete an online research-based task relating advances in technology to advances in scientific understanding, and vice versa.',
               taskWeighting: '20%',
               successCriteria: ['Specific task criteria will be handed out with the assessment notification closer to the due date.'],
           ...
           },
           {
               ...
               taskDescription: 'Students complete an in-class exam on a range of questions related to data analysis',
               taskWeighting: '20%',
               successCriteria: ['Specific task criteria will be handed out with the assessment notification closer to the due date.'],
           ...
           },
           {
               taskNumber: 3,
               taskName: 'Practical',
               taskDescription: 'Students complete a range of small practical or analytical activities in-class, largely based on Working Scientific Skills.',
               taskWeighting: '30%',
               successCriteria: ['Specific task criteria will be handed out with the assessment notification closer to the due date.'],
       ...
       tasks: [
           {
               ...
               taskDescription: 'Students complete a Depth Study on an investigation topic relating to a scientific concept of their choice.',
               taskWeighting: '30%',
               successCriteria: ['Specific task criteria will be handed out with the assessment notification closer to the due date.'],
           ...
           },
           {
               taskNumber: 2,
               taskName: 'Model Task',  
               taskDescription: 'Students design and construct a scientific model that demonstrates a particular scientific concept.',
               taskWeighting: '30%',
               successCriteria: ['Specific task criteria will be handed out with the assessment notification closer to the due date.'],
