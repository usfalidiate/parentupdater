        ...
        topic: [
            {
                ...
                topicDescription: <> Students learn that the experimental method is a dynamic process influenced by initial observations, new evidence, unexpected results or phenomena arising from the investigation. They examine the interrelated roles of practical and secondary-sourced investigations. When conducting practical and secondary-sourced investigations, students use peer feedback to refine their investigative designs and report on their findings. <br/> <br/> Students explore the importance of accuracy, validity and reliability in relation to the investigative work of a scientist. They examine the differences between a scientific investigation and a scientific report, recognising that although the report format follows a sequential order, the investigation need not. </>,
    ...
    {   //11INV
        ...
        topic: [
            ...
            },
            {
                ...
                topicDuration: "8 weeks",
                topicDescription: <> Scientific models are developed as a means of helping people understand scientific concepts and representing them in a visual medium. Models are used to make predictions. They may include physical and digital models, which can be refined over time by the inclusion of new scientific knowledge. <br/> <br/> Students recognise that many scientific models have limitations and are modified as further evidence comes to light. For this reason, scientific models are continually evaluated for accuracy and applicability by the global scientific community through the process of peer review. Students construct and evaluate their own models, which are generated through practical investigation. </>,
